    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <router-link :to="{name: 'admin'}" class="flex ms-2 md:me-24">
        ...
        <div class="flex items-center">
            <div class="flex items-center ms-3">
              ...
              <div class="z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm dark:bg-gray-700 dark:divide-gray-600"
                :class="ui.isMenuOpen ? 'block absolute -top-4 right-23 m-0 translate-x-[80px] translate-y-[58px]' : 'hidden'">
