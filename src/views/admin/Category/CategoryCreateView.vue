...
const onSubmit = handleSubmit(async (values, { resetForm }) => {
  try {
    ...
    useSweetAlert({ title: 'Categoría creada', text: 'La categoría ha sido creada con éxito', icon: 'success' });
    resetForm();
  } catch (err) {
    Swal.close();
  ...
  dark:bg-gray-800 dark:border-gray-700">
    <form action="" method="POST" @submit="onSubmit">
      <div class="mb-4">
        ...
        <input v-model="name" v-bind="nameAttrs" id="name" type="text" class="mb-1 bg-gray-50 border
        border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500
