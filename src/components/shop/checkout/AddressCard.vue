...
<template>
  ...
  >
    ...
    <div
      ...
      class="absolute top-3 right-3 z-10 bg-linear-to-r from-yellow-400 to-amber-500 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg flex items-center gap-1"
    >
    ...
    <div
      v-if="selected"
      class="absolute top-3 left-3 z-10 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center shadow-lg"
    >
      <font-awesome-icon icon="fa-solid fa-circle-check" class="text-white text-xs" />
    </div>
    ...
    <div class="p-5">
      ...
      <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 mb-3">
        <font-awesome-icon icon="fa-solid fa-location-arrow" class="text-gray-400 text-xs" />
    ...
    <div
      v-if="selected"
      class="absolute inset-0 bg-blue-600/5 dark:bg-blue-400/5 pointer-events-none"
    ></div>
  </div>
</template>
